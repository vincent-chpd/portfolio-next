  ...
  return (
    <div className="mx-10 py-20 md:px-20 flex flex-col gap-12 mb-6">
      ...
      <div>
        ...
        <h1 className="font-bold text-5xl mt-10">Recommendations</h1>
      ...
      <div className="bg-gray-800 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 relative overflow-hidden">
        ...
        <div className="flex flex-col gap-1 text-center md:text-left">
          ...
          <p className="text-gray-400 text-sm">Frontend Developer · London, UK</p>
          <Link
        ...
        <div className="md:ml-auto flex gap-6 md:gap-10 text-center shrink-0">
          <div>
      ...
      <div className="flex flex-col gap-6">
        {recommendations.map((rec) => (
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-[0.95rem] md:text-base">{rec.text}</p>

            <div className="flex items-center gap-4 pt-4 border-t border-gray-700">
              <div className="w-11 h-11 rounded-full bg-primary/20 text-primary flex items-center justify-center font-bold text-sm shrink-0 ring-1 ring-primary/30">
                {rec.avatar}
              </div>
              <div>
                <p className="font-semibold">{rec.name}</p>
                <p className="text-gray-400 text-sm">{rec.role}</p>
                <p className="text-gray-500 text-xs mt-0.5">{rec.relationship} · {rec.date}</p>
              </div>
