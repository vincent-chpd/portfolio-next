      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div>
          ...
          <div className="bg-background">
            <div className=" relative w-full h-100 my-10 mx-auto overflow-hidden mask-x-from-70% mask-x-to-100% mask-y-from-70% mask-y-to-100%  ">
              <Image
                src="/avatar.jpeg"
                alt="Profile Picture"
          ...
          <div className="border-l border-primary h-full">
            ...
            <div className="flex flex-col gap-4">
                <div className="flex items-start gap-4 flex-wrap relative">
                  <Image src={OmeaIdLogo} width={40} height={40} alt='Omea Id Logo' className="absolute right-8 top-4 rounded-lg"/>
                  ...
                  <div className="bg-gray-800 rounded-lg max-w-150 p-4 grid grid-cols-1 items-start justify-center gap-4 mx-4">
                    ...
                    <div className="flex flex-col gap-4 flex-wrap">
                      <div>
                        ...
                        <p className="text-sm "><i><a target='_blank' className="text-purple-300" href="https://www.linkedin.com/company/urbanthings/">OMEA ID</a> | London, UK</i></p>
                      </div>
                ...
                <div className="flex items-start gap-4 flex-wrap relative">
                <Image src={UrbanThingsLogo} width={40} height={40} alt='Urbanthings Logo' className="absolute right-8 top-4 rounded-lg"/>
                  <div className=" absolute top-5.75 w-2 h-2 rounded-full bg-primary -ml-1.25 z-50" />
                  <div className="bg-gray-800 rounded-lg max-w-150 p-4 grid grid-cols-1 items-start justify-center gap-4 mx-4">
                    ...
                    <div className="flex flex-col gap-4 flex-wrap">
                      <div>
                        ...
                        <p className="text-sm"><i><a target='_blank' href='https://www.linkedin.com/products/urbanthings-urbanhub/' className="text-purple-300">URBANTHINGS</a> | London, UK</i></p>
                      </div>
                ...
                <div className="flex items-start gap-4 flex-wrap relative">
                  <Image src={LeWagonLogo} width={40} height={40} alt='Urbanthings Logo' className="absolute right-8 top-4 rounded-lg"/>
                  <div className=" absolute top-5.75 w-2 h-2 rounded-full bg-primary -ml-1.25 z-50" />
                  <div className="bg-gray-800 rounded-lg max-w-150 p-4 grid grid-cols-1 items-start justify-center gap-4 mx-4">
                    ...
                    <div className="flex flex-col gap-4 flex-wrap">
                      <div>
                        ...
                        <p className="text-sm"><i><a className="text-purple-300" target='_blank' href='https://www.linkedin.com/company/le-wagon-london/'>LE WAGON</a>, London, UK</i></p>
                      </div>
